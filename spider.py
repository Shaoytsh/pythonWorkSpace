...
class Spider:
    ...
    def saveImgs(self,images,name):
        print("saveImgs")
        number = 1
        print ("发现",name,u"共有",len(images),u"张照片")
    ...
    def saveImg(self,imageURL,fileName):
        print("图片路径1",imageURL)
        print("图片路径2", fileName)
        ...
        #urllib.request.urlretrieve("https:"+imageURL, fileName)
    ...
    def savePagesInfo(self,start,end):
        for i in range(start,end+1):
            print ("正在偷偷寻找第",i,u"个地方，看看MM们在不在")
            self.savePageInfo(i)
